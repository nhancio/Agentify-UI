...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 z-40 h-full w-64 bg-white dark:bg-gray-900 shadow-sm border-r border-gray-200 dark:border-gray-700 transition-transform duration-300 pt-16
            ...
            {navigation.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center px-3 py-2 rounded-lg text-sm font-medium transition-all duration-300 group text-left ${
                    isActive
