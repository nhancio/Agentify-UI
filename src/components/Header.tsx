  ...
  return (
    <header className={headerClasses}>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full'>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className='lg:hidden absolute top-16 left-0 right-0 w-full bg-white dark:bg-gray-900 shadow-lg rounded-b-lg border-t border-gray-200 dark:border-gray-700 animate-in slide-in-from-top duration-300'>
