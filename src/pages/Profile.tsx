          ...
          {loading ? (
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="text-lg font-semibold text-gray-900">{googleProfile?.name || profile?.full_name || 'User'}</div>
                  <div className="text-sm text-gray-500">{googleProfile?.email || profile?.email}</div>
                </div>
              </div>
