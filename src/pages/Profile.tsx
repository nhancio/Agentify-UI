...
const Profile: React.FC = () => {
  ...
  const handleAddCredits = () => {
    // Navigate to billing page to select a plan
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="col-span-1 bg-white dark:bg-gray-900 rounded-2xl shadow-xl p-8 flex flex-col items-center text-center relative overflow-hidden border border-blue-100 dark:border-blue-900/30">
            ...
            <div className="flex flex-col items-center flex-1">
                ...
                <div className="w-24 h-24 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full flex items-center justify-center text-white text-4xl font-bold mb-4 shadow-lg">
                  {googleProfile?.name
                    ? googleProfile.name
                      ...
                      .join("")
                      .toUpperCase()
                    : (profile?.full_name || profile?.name || "JD")
                      .split(" ")
                      .map((n: string) => n[0])
                      .join("")
                      .toUpperCase()}
              ...
              <TypewriterText
                texts={[
                  `Welcome back, ${googleProfile?.name || profile?.full_name || "User"
                  }!`,
            ...
            <div className="w-full mt-auto">
              ...
              <AnimatedButton
                ...
                className="w-full mt-2"
              >
                <a href="mailto:agentlybot@gmail.com">Support</a>
              </AnimatedButton>
            </div>
          </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {mockStats.map((stat, i) => (
                    <div key={i} className="flex flex-col items-center">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 bg-${stat.color}-100 dark:bg-${stat.color}-900/30`}
                      >
                        <stat.icon
              ...
              {/* <div className="bg-gradient-to-br from-yellow-50 to-purple-50 dark:from-yellow-900/20 dark:to-purple-900/20 rounded-2xl shadow-xl p-6 border border-yellow-100 dark:border-yellow-900/30 flex flex-col items-center justify-center">
                ...
                <div className="flex gap-4">
                  {mockAchievements.map((ach, i) => (
                    <div key={i} className={`flex flex-col items-center`}>
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center mb-2 bg-${ach.color}-100 dark:bg-${ach.color}-900/30`}
                      >
                        <ach.icon
                          className={`w-6 h-6 text-${ach.color}-600 dark:text-${ach.color}-400`}
                        />
                      </div>
                      <div className="text-xs text-gray-700 dark:text-gray-300 font-semibold text-center whitespace-nowrap">
                        {ach.label}
                      </div>
                    </div>
                  ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-blue-50 dark:from-yellow-900/20 dark:to-blue-900/20 rounded-2xl shadow-xl p-6 border border-yellow-100 dark:border-yellow-900/30 flex flex-col gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-black/5 dark:bg-white/5 rounded-lg p-4">
                  ...
                  <AnimatedButton
                    variant="secondary"
                    className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-4 py-2 rounded-lg flex items-center gap-2 transition"
                ...
                {/* <AnimatedButton
                  className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold py-3 rounded-lg flex items-center justify-center gap-2 mt-2 hover:from-purple-700 hover:to-blue-700 transition"
