...
const Landing: React.FC = () => {
  ...
  const features = [
    {
      ...
      description:
        "Create intelligent voice and video agents that handle conversations naturally and efficiently.",
    ...
    },
    {
      ...
      title: "Voice Calls",
      description:
        "Automated phone agents for HR screening, bookings, lead generation, and customer support.",
    ...
    },
    {
      ...
      title: "Video Agents",
      description:
        "Lifelike video agents powered by Tavus for websites, presentations, and interactive experiences.",
    ...
    },
    {
      ...
      description:
        "Build and customize agents without coding. Drag, drop, and configure in minutes.",
    ...
    },
    {
      ...
      description:
        "GDPR compliant with secure data handling and consent management built-in.",
    ...
    },
    {
      ...
      description:
        "Track performance, analyze conversations, and optimize your agents with detailed insights.",
  ...
  const useCases = [
    {
      ...
      description:
        "Automate initial candidate screening with intelligent interview agents that ask the right questions.",
      image:
    ...
    },
    {
      ...
      description:
        "Handle room bookings, guest inquiries, and reservation management 24/7 with multilingual support.",
      image:
    ...
    },
    {
      ...
      description:
        "Qualify leads, schedule appointments, and nurture prospects automatically with intelligent conversations.",
      image:
        "https://images.pexels.com/photos/3760778/pexels-photo-3760778.jpeg?auto=compress&cs=tinysrgb&w=400",
  ...
  const videoAgentPreviews = [
    {
      ...
      description:
        "Professional AI recruiter conducting candidate screenings with natural conversation flow and skill assessment.",
    ...
    },
    {
      ...
      description:
        "Multilingual hospitality expert providing 24/7 guest services, room bookings, and local recommendations.",
      videoUrl: "https://player.vimeo.com/video/891679646?autoplay=1&loop=1",
      thumbnailUrl:
        "https://images.pexels.com/photos/271618/pexels-photo-271618.jpeg?auto=compress&cs=tinysrgb&w=400",
    ...
    },
    {
      ...
      description:
        "Persuasive sales professional qualifying leads, scheduling demos, and closing deals with high conversion rates.",
      videoUrl: "https://player.vimeo.com/video/891679646?autoplay=1&loop=1",
      thumbnailUrl:
        "https://images.pexels.com/photos/3760778/pexels-photo-3760778.jpeg?auto=compress&cs=tinysrgb&w=400",
  ...
  const testimonials = [
    {
      ...
      content:
        "Agentlybot.com has revolutionized our recruitment process. We screen 10x more candidates while maintaining quality. The AI agents are incredibly natural and professional.",
      rating: 5,
      avatar: "SJ",
    },
    {
      ...
      role: "Hotel Manager",
      content:
        "Our booking efficiency increased by 300%. Guests love the instant response and professional service. The multilingual support is a game-changer for our international clientele.",
      rating: 5,
      avatar: "MC",
    },
    {
      ...
      role: "Sales Manager",
      content:
        "The lead qualification agents have transformed our sales pipeline. More qualified leads, less manual work, and our team can focus on closing deals instead of screening calls.",
      rating: 5,
      avatar: "ER",
    },
  ];
  ...
  return (
    <div className='min-h-screen w-full bg-white dark:bg-gray-900 transition-colors duration-300 overflow-x-hidden'>
            ...
            <div className='mb-8'>
              <div className='inline-flex items-center px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-white mb-6'>
                ...
                <span className='text-sm font-medium'>
                  Now with Advanced AI Voice & Video Technology
                </span>
              </div>
              ...
              <div className='flex items-center justify-center mb-8'>
                ...
                <p className='text-xl md:text-2xl text-blue-100 max-w-4xl leading-relaxed'>
                  Create intelligent voice and video agents for HR screening,
                  hotel bookings, sales calls, and more. No coding required.
                  Deploy in minutes.
                </p>
              </div>
            </div>
      ...
      <VideoAgentShowcase
        onTryNow={() => (window.location.href = "/video-agents")}
      />
        ...
        <div className='max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8'>
          <ScrollReveal direction='up'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                Our platform provides all the tools and integrations you need to
                create, deploy, and manage AI agents that deliver real business
                results.
              </p>
            </div>
          </ScrollReveal>
            ...
            {features.map((feature, index) => (
              <ScrollReveal key={index} direction='up' delay={index * 100}>
                <div className='group relative p-8 rounded-2xl bg-white dark:bg-gray-800 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-200 dark:border-gray-700'>
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${feature.gradient} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10 blur-xl`}
                  />

                  <div
                    className={`w-12 h-12 bg-gradient-to-r ${feature.gradient} bg-opacity-100 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <ScrollReveal direction='up'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                Watch how our AI agents handle calls from start to finish,
                creating valuable insights and leads automatically.
              </p>
            </div>
          </ScrollReveal>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <ScrollReveal direction='up'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                See how businesses are using agentlybot.com and get the latest
                updates.
              </p>
            </div>
          </ScrollReveal>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <ScrollReveal direction='up'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto'>
                Get real-time insights into your AI agents' performance with our
      ...
      {/* Pricing Section */}
      <section
        className='py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 relative overflow-hidden'
        id='pricing-section'
      >
        <div className='absolute inset-0'>
          <div className='absolute top-1/4 left-10 w-72 h-72 bg-blue-500/20 rounded-full blur-3xl animate-pulse' />
          <div
            className='absolute bottom-1/4 right-10 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse'
          ...
          <ScrollReveal direction='up'>
            <div className='mb-8'>
              ...
              <p className='text-xl text-gray-600 dark:text-gray-300 mb-8'>
                Join thousands of businesses already using agentlybot.com to
                automate conversations and grow their business.
              </p>
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
                ...
                <AnimatedButton
                  ...
                  onClick={() =>
                    window.open(
                      "https://calendly.com/nithindidigam/platform-demo",
                      "_blank",
                    )
                  }
                >
      ...
      <footer className='bg-gray-900 dark:bg-black text-white py-16 w-full'>
        <div className='max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            <div>
              ...
              <p className='text-gray-400 mb-4'>
                The future of AI-powered customer interactions. Build
          ...
          <div className='border-t border-gray-800 mt-12 pt-8 text-center text-gray-400'>
            <p>
              &copy; 2024 agentlybot.com. All rights reserved. Built with ❤️ for
              the future of AI.
            </p>
          </div>
        </div>
